...
public class Main {
    public static void main(String[] args) {
        ...
        Alumno alumno1 = new Alumno("Mateo Bellinzona",5 ,  "Egresado");
        ...
        // Agregar alumnos y preceptores a los cursos
        ...
        alumno1.setNota(Lengua, 8);
        alumno1.setNota(EducacionFisica, 9);

        alumno8.setNota(matematicas, 6);
        alumno8.setNota(Lengua, 5);
        alumno8.setNota(EducacionFisica, 8);
        // Métodos
        ...
        System.out.println();
        Curso1.mostrarNotasAlumno("Mateo Bellinzona");
        System.out.println();
        ...
        Curso2.mostrarNotasAlumno("Matias Pereyra");
        System.out.println();
    }
}